  ...
  return knex('items')
    .then(function () {
      ...
      return knex('items').insert([
        ...
        {userId: 2, name: "Cuddle Team Leader", price: 25, description: "Hug it out.", category: "outfits", availability: false, img_url: "https://cdn.thetrackernetwork.com/cdn/fortnite/22163_large.png", userId: 1, username: "scott", buyerId: 3 },
        ...
        {userId: 4, name: "Royale Knight", price: 5, description: "The dauntless champion of Tomato Town", category: "outfits", availability: false, img_url: 'https://cdn.thetrackernetwork.com/cdn/fortnite/AF497_large.png', userId: 2, username: "sam", buyerId: 5 },
        ...
        {userId: 6, name: "Floss", price: 29, description: "Express yourself on the battlefield.", category: "emotes", availability: false, img_url: "https://cdn.thetrackernetwork.com/cdn/fortnite/9AB75723_large.png", userId: 2, username: "sam", buyerId: 1 },
        ...
        {userId: 9, name: "Hype", price: 80, description: "Get hyped.", category: "emotes", availability: false, img_url: "https://cdn.thetrackernetwork.com/cdn/fortnite/DD585730_large.png", userId: 3, username: "jordan", buyerId: 9 },
        {userId: 10, name: "Take the L", price: 3, description: "Savor the W.", category: "emotes", availability: false, img_url: "https://cdn.thetrackernetwork.com/cdn/fortnite/ACC45741_large.png", userId: 4, username: "tom", buyerId: 10 },
        ...
        {userId: 12, name: "Beach Ball", price: 3, description: "Summer fun!", category: "toys", availability: false, img_url: "https://cdn.thetrackernetwork.com/cdn/fortnite/80105903_large.png", userId: 5, username: "brock", buyerId: 5 },
        ...
        {userId: 14, name: "Football", price: 4, description: "Go long...", category: "toys", availability: false, img_url: "https://cdn.thetrackernetwork.com/cdn/fortnite/436D6920_large.png", userId: 6, username: "lebron", buyerId: 8 },
        {userId: 15, name: "Bouncy Ball", price: 8, description: "Boing boing!", category: "toys", availability: false, img_url: "https://cdn.thetrackernetwork.com/cdn/fortnite/0C2110971_large.png", userId: 7, username: "kevin", buyerId: 5 },
        ...
        {userId: 19, name: "Squirtle", price: 100, description: "One part squirrel, one part turtle", category: "pets", availability: false, img_url: "https://cdn.bulbagarden.net/upload/thumb/3/39/007Squirtle.png/500px-007Squirtle.png", userId: 9, username: "quinn", buyerId: 1 },
